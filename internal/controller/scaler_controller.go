...
import (
	...
	apiv1alpha1 "github.com/odogwuVal/deployment-scaling-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=api.odogwuval.org,resources=scalers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.odogwuval.org,resources=scalers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.odogwuval.org,resources=scalers/finalizers,verbs=update
